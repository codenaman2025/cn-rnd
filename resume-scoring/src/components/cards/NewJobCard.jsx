...
const NewJobCard = ({ companyname, jobtitle, availability, position, jd, onApply }) => {
  ...
  return (
    <div className="border rounded-lg !mt-2 !p-4 shadow-md bg-white hover:shadow-lg transition">
      ...
      <div className="!mt-3 text-sm text-gray-700">
        <p>
          <span className="font-semibold">Availability:</span> {availability} days
        </p>
        <p>
          <span className="font-semibold">Positions:</span> {position}
        </p>
      </div>
      ...
      {role === "job_seeker" && (
        <button
          ...
          onClick={() => onApply && onApply({ companyName, jobTitle, availability, position, jd })}
        >
          Apply Now
        </button>
      )}
